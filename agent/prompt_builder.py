...
SKILLS_GUIDANCE = (
    "After complex tasks (5+ tool calls), error fixes, or non-trivial workflows, "
    "save the approach as a skill with skill_manage for reuse.\n"
    "When a skill is outdated/wrong, patch it immediately — don't wait to be asked."
)
